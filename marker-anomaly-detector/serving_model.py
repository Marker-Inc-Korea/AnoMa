...
DATABASE_URL = 'mkseoul.iptime.org'
DATABASE_PORT = 6076
DATABASE_NAME = 'prometheus'
DATABSAE_USERNAME = 'root'
DATABSAE_PASSWORD = 'root'

db_client = InfluxDBClient(DATABASE_URL, DATABASE_PORT, DATABSAE_USERNAME,DATABSAE_PASSWORD,  DATABASE_NAME)



def serving_model(model=None, initial_run = False, rolling_size = '3d'):
...
if __name__ == "__main__":
    ...
    serving_model(model , initial_run=True)
